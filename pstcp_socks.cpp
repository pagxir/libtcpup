...
void pstcp_socks::tc_callback(void *context)
{
	pstcp_socks *chan;
	chan = (pstcp_socks *)context;
...
void new_pstcp_socks(struct tcpcb *tp)
{
	/* int error; */
	pstcp_socks *chan;
   	chan = new pstcp_socks(tp);
